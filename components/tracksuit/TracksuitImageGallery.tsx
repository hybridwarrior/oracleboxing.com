...
interface TracksuitImageGalleryProps {
...
// Image configuration for full tracksuit (hoodie + joggers)
const imageConfigs = [
  { label: 'Hoodie Front', prefix: 'hoodie', angle: 'front', type: '' },
  { label: 'Hoodie Back', prefix: 'hoodie', angle: 'back', type: '' },
  { label: 'Hoodie Model Front', prefix: 'hoodie', angle: 'front', type: 'model' },
  { label: 'Hoodie Model Back', prefix: 'hoodie', angle: 'back', type: 'model' },
  { label: 'Joggers Front', prefix: 'jogger', angle: 'front', type: '' },
  { label: 'Joggers Back', prefix: 'jogger', angle: 'back', type: '' },
  { label: 'Joggers Model Front', prefix: 'jogger', angle: 'front', type: 'model' },
  { label: 'Joggers Model Back', prefix: 'jogger', angle: 'back', type: 'model' },
]

export function TracksuitImageGallery({ selectedColor, children }: TracksuitImageGalleryProps) {
  const sectionRef = useRef<HTMLDivElement>(null)
  const imageScrollRef = useRef<HTMLDivElement>(null)
  const [mobileImageIndex, setMobileImageIndex] = useState(1) // Start with hoodie back image
  ...
  return (
    <>
      {/* Desktop Layout */}
      <div ref={sectionRef} className="hidden lg:block" style={{ height: '300vh' }}>
