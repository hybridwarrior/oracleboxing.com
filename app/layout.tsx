...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: 'https://media.oracleboxing.com/favicon/favicon.ico' },
      { url: 'https://media.oracleboxing.com/favicon/favicon-16x16.png', sizes: '16x16', type: 'image/png' },
      { url: 'https://media.oracleboxing.com/favicon/favicon-32x32.png', sizes: '32x32', type: 'image/png' },
    ],
    apple: 'https://media.oracleboxing.com/favicon/apple-touch-icon.png',
    other: [
      { rel: 'android-chrome-192x192', url: 'https://media.oracleboxing.com/favicon/android-chrome-192x192.png' },
      { rel: 'android-chrome-512x512', url: 'https://media.oracleboxing.com/favicon/android-chrome-512x512.png' },
    ],
  },
  openGraph: {
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
        ...
        <link rel="icon" type="image/x-icon" href="https://media.oracleboxing.com/favicon/favicon.ico" />
        <link rel="icon" type="image/png" sizes="16x16" href="https://media.oracleboxing.com/favicon/favicon-16x16.png" />
        <link rel="icon" type="image/png" sizes="32x32" href="https://media.oracleboxing.com/favicon/favicon-32x32.png" />
        <link rel="apple-touch-icon" sizes="180x180" href="https://media.oracleboxing.com/favicon/apple-touch-icon.png" />
        <link rel="apple-touch-icon" sizes="167x167" href="https://media.oracleboxing.com/favicon/apple-touch-icon-167x167.png" />
        <link rel="mask-icon" href="https://media.oracleboxing.com/favicon/safari-pinned-tab.svg" color="#000000" />
