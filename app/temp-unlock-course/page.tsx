...
export default function TempUnlockCoursePage() {
              ...
              {!submitted ? (
                <>
                  ...
                  <div className="lg:hidden mb-6">
                    <div className="bg-[#37322F] rounded-2xl p-6 text-white">
                      <h3 className="text-lg font-medium mb-1">Unlock Your Courses</h3>
                      <p className="text-white/70 text-sm">Enter your email to unlock access to your courses</p>
                    </div>
                  </div>
                ...
                <div className="flex flex-col items-center justify-center h-full py-12">
                  ...
                  <p className="text-[#605A57] text-center max-w-sm mb-8">
                    We&apos;ve sent your course access details to your email. It can take up to 10 minutes to arrive.
                  </p>
            ...
            <div className="order-1 lg:order-2 hidden lg:block py-8 lg:py-12">
              <div className="flex flex-col h-full">
                ...
                <div className="bg-[#37322F] rounded-2xl p-6 mb-6 text-white">
                  <h3 className="text-lg font-medium mb-1">Unlock Your Courses</h3>
                  <p className="text-white/70 text-sm mb-6">Enter your email to unlock access to your courses</p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-white/90 text-sm font-medium">Email Confirmation</p>
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      "We'll unlock your course access",
